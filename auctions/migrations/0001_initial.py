# Generated by Django 3.0.8 on 2020-10-13 04:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_Category', models.CharField(blank=True, max_length=64, null=True)),
                ('item_isActive', models.BooleanField()),
                ('item_Owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owner', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('com_Listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.Listing')),
